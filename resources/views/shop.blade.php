        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
            <div class="product d-flex flex-column">
              <a href="{{ route('add.to.cart', $product->id) }}" class="img-prod">
                @empty($product->foto)
                <img class="img-fluid" src="{url('admin/img/nophoto.jpg')}}" alt="Colorlib Template">
                @else
                <img class="img-fluid" src="{{url('admin/img')}}/{{$product->foto}}" alt="Colorlib Template">
                @endempty
...
{{-- @else
	<!-- End Hero Section -->
  <div class="untree_co-section product-section before-footer-section pt-10">
